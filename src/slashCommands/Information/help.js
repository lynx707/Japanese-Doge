...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    const embed = new MessageEmbed()
        .setColor(`#DDBD86`)
          .setAuthor({ name: `${client.user.username}`, iconURL: client.user.displayAvatarURL(), url: `https://discord.gg/ZtNWe8wSaw` })

          .setDescription(`
<:notes:1119915814733217843> **Music:**
<:blank:1207643268125425695><:next:1119915811415539722> **/play:** Joins your voice channel and starts playing 24/7.
<:blank:1207643268125425695><:stop:1119915842893783052> **/stop:** Leaves the voice channel.
<:blank:1207643268125425695><:dvd:1119915776732827778> **/song:** Shows the current playing song.
<:blank:1207643268125425695><:radio:1119915830344437790> **/station:** Changes the radio station/theme.
<:blank:1207643268125425695><:loud:1119915800535511070> **/volume:** Shows or changes the current volume.
<:blank:1207643268125425695><:sleep:1119915834886856785> **/sleep:** Sets a sleep timer.
<:star:1119915839064379472> **Profiles:**
<:blank:1207643268125425695><:profile:1119915826326278265> **/profile:** Shows your profile.
<:blank:1207643268125425695><:am:1121668225839661076> **/remove:** Removes the liked song.
<:blank:1207643268125425695><:floppy_disk:1119915780931338280> **/collection:** Shows your liked songs collection.
<:config:1119915722534039612> **Config:**
<:blank:1207643268125425695><:mode:1119915805056966717> **/mode:** Switches between radio modes.
<:blank:1207643268125425695><:dj:1119915773742288917> **/djrole:** Sets which roles are considered DJs.
<:blank:1207643268125425695><:gear:1119915784756531331> **/settings:** Shows and configures server settings.
<:blank:1207643268125425695><:premium:1119915823964893214>  **/premium:** Shows information about Lofi Radio premium.
<:info:1119915789030535178> **Info:**
<:blank:1207643268125425695><:telegram:1119915847809515671> **/support:** Send us a message or [join](https://discord.gg/ZtNWe8wSaw) our support server.
<:blank:1207643268125425695><:like:1119915795565269112> **/vote:** Vote for Lofi Radio.
<:blank:1207643268125425695><:invite:1119915791521955970> **/invite:** [Invite](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot%20applications.commands) Lofi Radio to your server.
`)
...
const b1 = new MessageButton().setLabel(`Play`).setCustomId(`play`).setEmoji(`1119915811415539722`).setStyle('SECONDARY').setDisabled(false)
    ...
    .setURL(`https://discord.gg/ZtNWe8wSaw`)
...
const player = client.manager.players.get(i.guild.id);
      ...
      description: `👋`
        ...
        return await i
          .followUp({ embeds: [{
      color: '#DDBD86',
      description: `**<:error:1207643278711980093> | Erorr**`
    }], ephemeral: true})
          .catch(() => { });
      }
...
await i.followUp({ embeds: [{
      color: '#DDBD86',
      description: `<:stop:1207643335452393492> Successfully disconnected from ${i.member.voice.channel}
 `
    }]})
   ...
   return await i
          .followUp({ embeds: [{
      color: '#DDBD86',
      description: `**<:error:1207643278711980093> | Queue Undefined**`
    }], ephemeral: true})
}
